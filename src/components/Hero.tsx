...
<section className="relative bg-hero overflow-hidden">
    <div className="container mx-auto grid md:grid-cols-2 items-center min-h-[520px] gap-8 px-4 pt-28 pb-16 md:pt-32 md:pb-20">
      ...
      className="hidden md:block">
        ...
        <img alt="Digital marketing team analyzing data dashboards" className="w-full h-full rounded-lg object-cover" src="/lovable-uploads/76901592-0728-41a0-bd71-68c061f3771d.jpg" />
      </motion.div>
    </div>
    {/* Diagonal bottom */}
